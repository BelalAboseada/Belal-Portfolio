...
import cloude from "@/assets/claude-color.svg";
import antigravity from "@/assets/antigrvity-2.png";

export const skillsData: Skill[] = [
  { id: 2, title: "Typescript", img: Ts, Cat: "Skills" },
  { id: 4, title: "React", img: React, Cat: "Skills" },
  { id: 5, title: "Redux", img: Redux, Cat: "Skills" },
  { id: 1, title: "Node.js", img: Node, Cat: "Skills" },
  { id: 3, title: "Mongo db", img: Mongodb, Cat: "Skills" },
  ...
  { id: 17, title: "cloude", img: cloude, Cat: "Tools" },
  { id: 18, title: "Agile(Scrum)", img: Agile, Cat: "Tools" },
  { id: 18, title: "antigravity", img: antigravity, Cat: "Tools" },
